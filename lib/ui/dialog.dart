                            ...
                            Flexible(
                                ...
                                child: Column(
                                    children: [
                                      ...
                                      design.Txtvolk(
                                          _tenureType, FontWeight.w400, 12,
                                          Colors.black),
                                      Switch(
                                          value: _switchValue,
                    ...
                    Builder(
                      builder: (context) {
                        return GestureDetector(
                          onTap: () {
                            BlocProvider.of<CounterCubit>(context).increment(a:_principalAmount.text , b:_interestRate.text,c: _tenure.text,d: _tenureType );
                          },
                          child: Container(
                            width: 140,
                            height: 50,
